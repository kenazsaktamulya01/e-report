										...
										<div class="post-bar">
											<div class="post_topbar">
												...
												<?php if (@$_SESSION["user"]) {
													...
													if ($tampil_report['foto'] != "") {
														echo "<img src='foto/profil/" . $tampil_report['foto'] . "' width='50' height='50' />";
													} else {
														echo "<img src='foto/profil/default.png' width='50' height='50' />"; // Tambahkan gambar default
													}
												}
											...
											<div class="job_descp">
												...
												<?php 
													...
													if (!empty($tampil_report['gambar_pengaduan'])) {
														echo "<img class='mb-3 img-thumbnail col-lg-12' src='foto2/" . $tampil_report['gambar_pengaduan'] . "' width='100' height='300'/>";
													}
													?>
