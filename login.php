...
<div class="login-form">
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary btn-lg btn-block" name="tombol">Sign in</button>
        </div>
    ...
    <p class="text-center small">Belum punya akun?<a href="register.php">Daftar di sini!</a></p>
    <?php
    include "config.php";
    session_start();

    // Pastikan variabel 'user' dan 'pass' ada sebelum menggunakannya
    $user = isset($_POST['user']) ? $koneksi->real_escape_string($_POST['user']) : '';
    $pass = isset($_POST['pass']) ? $koneksi->real_escape_string(md5($_POST['pass'])) : '';

    // Cek apakah tombol submit ('tombol') diklik
